...
The GOV.UK Flooding uses [standardjs](http://standardjs.com/), an opinionated JavaScript linter. All JavaScript files follow its conventions, and it runs on CI to ensure that new pull requests are in line with them.
...
If you want to submit a pull request to the GOV.UK Flooding, your code will need to pass the linter.

If you're just using the GOV.UK Flooding in a separate project, then no, you aren't forced to use standard, or any other linter for that matter. Just write code as you would normally.
