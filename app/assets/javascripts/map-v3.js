...
removeLayers();
  ...
  if (pathname == '/version_5/map-v3/surface-water'){
    map.addLayer(surfaceWater(x))
    markerAddressRadius();
  } else if (pathname == '/version_5/map-v3/surface-water-depth'){
    map.addLayer(surfaceWaterDepth(x)),
    markerAddressRadius();
  } else if (pathname == '/version_5/map-v3/surface-water-velocity'){
...
//get Center of map
  let center = map.getView().getCenter()
      ...
      if (this.value == '1') {
        ...
        //surface water
      window.location.href = "/version_5/map-v3/surface-water?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center
    }
    else if (this.value == '2') {

      // rivers and sea
      window.location.href = "/version_5/map-v3/rivers-sea?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center
    } else if (this.value == '3') {
    
      //reservoirs
      window.location.href = "/version_5/map-v3/reservoirs?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center
...
//get radio value
 ...
 let center = map.getView().getCenter()
  ...
  //Surface water depth
  window.location.href = "/version_5/map-v3/surface-water-depth?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center

} else if (this.value == '9') {

  //Surface water speed
  window.location.href = "/version_5/map-v3/surface-water-velocity?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center
} 
});
