...
function setCenter(){
  ...
  if (center == undefined){
    mapCenter = [-1.0903145024537895, 53.77866456981307]
  } else {
...
// google maps: 53.77866456981307, -1.0903145024537895 
// app: -1.0903145024537895, 53.77866456981307
...
var marker = new Feature({
  geometry: new Point([-1.0903145024537895, 53.77866456981307]),
  type: 'test',
  name: 'something'
});
...
removeLayers();
  ...
  if (pathname == '/map-v2-alt/surface-water'){
    map.addLayer(surfaceWater(x))
    markerAddressRadius();
  } else if (pathname == '/map-v2-alt/surface-water-depth'){
    map.addLayer(surfaceWaterDepth(x)),
    markerAddressRadius();
  } else if (pathname == '/map-v2-alt/surface-water-velocity'){
    map.addLayer(surfaceWaterSpeed(x)),
    map.addLayer(surfaceWaterDirection(x)),
    markerAddressRadius();
  } else if (pathname == '/map-v2-alt/rivers-sea'){
    map.addLayer(riverSea(x)),
    markerAddress();
  } else if (pathname == '/map-v2-alt/reservoirs'){
...
//get Center of map
  let center = map.getView().getCenter()
      ...
      if (this.value == '1') {
        ...
        //surface water
      window.location.href = "/map-v2-alt/surface-water?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center
    }
    else if (this.value == '2') {

      // rivers and sea
      window.location.href = "/map-v2-alt/rivers-sea?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center
    } else if (this.value == '3') {
    
      //reservoirs
      window.location.href = "/map-v2-alt/reservoirs?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center
...
//get radio value
 ...
 let center = map.getView().getCenter()
  ...
  //Surface water depth
  window.location.href = "/map-v2-alt/surface-water-depth?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center

} else if (this.value == '9') {

  //Surface water speed
  window.location.href = "/map-v2-alt/surface-water-velocity?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center
} 
});
