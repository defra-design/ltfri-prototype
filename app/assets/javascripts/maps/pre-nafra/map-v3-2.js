...
//get Center of map
  let center = map.getView().getCenter()
      ...
      if (this.value == '1') {
        ...
        //surface water
      window.location.href = "/version_5/map-v3-2/surface-water?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center
    }
    else if (this.value == '2') {

      // rivers and sea
      window.location.href = "/version_5/map-v3-2/rivers-sea?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center
    } else if (this.value == '3') {
    
      //reservoirs
      window.location.href = "/version_5/map-v3-2/reservoirs?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center
...
//get radio value
 ...
 let center = map.getView().getCenter()
  ...
  //Surface water depth
  window.location.href = "/version_5/map-v3-2/surface-water-depth?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center

} else if (this.value == '9') {

  //Surface water speed
  window.location.href = "/version_5/map-v3-2/surface-water-velocity?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center
} 
});
