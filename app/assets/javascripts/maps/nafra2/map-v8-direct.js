...
/*     markerAddressRadius(); */
  ...
  /*   markerAddress(); */
    ...
    else if (pathname == '/version_9/nafra2-direct-map/rivers-sea-depth'){
...
$('input[name="risk-type"]').change(function() {
  ...
  if (this.value == '1') {
    // Surface water
    window.location.href = "/version_9/nafra2-direct-map/surface-water?marker=" + setCheckbox + "&scenario=" + setRadio + "&center=" + center + "&zoom=" + zoom;
  } else if (this.value == '2') {
    // Rivers and sea
    window.location.href = "/version_9/nafra2-direct-map/rivers-sea?marker=" + setCheckbox + "&scenario=" + setRadio + "&center=" + center + "&zoom=" + zoom;
  } else if (this.value == '3') {
    // Reservoirs
    window.location.href = "/version_9/nafra2-direct-map/reservoirs?marker=" + setCheckbox + "&scenario=" + setRadio + "&center=" + center + "&zoom=" + zoom;
  } else if (this.value == '23') {
    // Surface water speed
    window.location.href = "/version_9/nafra2-direct-map/rivers-sea-depth?marker=" + setCheckbox + "&scenario=" + setRadio + "&center=" + center + "&zoom=" + zoom;
  }
});
...
if (window.location.pathname.includes("/version_9/nafra2-direct-map/surface-water-depth") || window.location.pathname.includes("/version_9/nafra2-direct-map/surface-water-velocity") || window.location.pathname.includes("/version_9/nafra2-direct-map/rivers-sea-depth")) {
...
$(document).ready(function () {
  ...
  function handleDisplayLayersCheckbox() {
    ...
    else if (currentPath === '/version_9/nafra2-direct-map/rivers-sea' || currentPath === '/version_9/nafra2-direct-map/reservoirs' || currentPath === '/version_9/nafra2-direct-map/rivers-sea-depth')
      removeLayers();
      /* markerAddress(); */
    }
    ...
    markerAddressRadius() */
      ...
      else if (currentPath === '/version_9/nafra2-direct-map/rivers-sea-depth') {
...
$(document).ready(function () {
  ...
  exitButton.on('click', function () {
    // Navigate to another page
    window.location.href = '/version_9/nafra2-direct-map/rivers-sea.html';
  });
});
...
$(document).ready(function () {
  ...
  exitButton.on('click', function () {
    // Navigate to another page
    window.location.href = '/version_9/nafra2-direct-map/reservoirs.html';
  });
});
...
$(document).ready(function () {
  ...
  exitButton.on('click', function () {
    // Navigate to another page
    window.location.href = '/version_9/nafra2-direct-map/surface-water.html';
  });
});