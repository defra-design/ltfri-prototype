...
removeLayers();
  ...
  if (pathname == '/version_13/nafra2-direct-map/surface-water'){
  ...
  else if (pathname == '/version_13/nafra2-direct-map/surface-water-cc'){
    // nafra2-direct-map to show more risk (2050)
    map.addLayer(surfaceWaterDepth(3));
  }
  else if (pathname == '/version_13/nafra2-direct-map/surface-water-depth'){
    map.addLayer(surfaceWaterDepth(3));
  }
  else if (pathname == '/version_13/nafra2-direct-map/surface-water-depth-future'){
      map.addLayer(surfaceWaterDepth(3));
  } 
  else if (pathname == '/version_13/nafra2-direct-map/surface-water-velocity'){
    map.addLayer(surfaceWaterSpeed(x)),
    map.addLayer(surfaceWaterDirection(x));
  } 
  else if (pathname == '/version_13/nafra2-direct-map/rivers-sea'){
    map.addLayer(surfaceWaterDepthRos(1));
  }
  else if (pathname == '/version_13/nafra2-direct-map/rivers-sea-cc'){
    map.addLayer(surfaceWaterDepthRos(2));
  }
  else if (pathname == '/version_13/nafra2-direct-map/rivers-sea-depth'){
    map.addLayer(surfaceWaterDepthRos(3));
  }
  else if (pathname == '/version_13/nafra2-direct-map/rivers-sea-depth-future'){
      map.addLayer(surfaceWaterDepthRos(3));
  }
  else if (pathname == '/version_13/nafra2-direct-map/reservoirs'){
...
//get Center of map
  ...
  var zoom = map.getView().getZoom(); // Get the current zoom level
      ...
      window.location.href = "/version_13/nafra2-direct-map/surface-water-cc?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center+ "&zoom=" + zoom;
    }
    else if (this.value == '33') {
    
      window.location.href = "/version_13/nafra2-direct-map/surface-water-depth-future?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center+ "&zoom=" + zoom;
      
    } 
    // rivers and the sea 2050 
    else if (this.value == '34') {
    
      window.location.href = "/version_13/nafra2-direct-map/rivers-sea-cc?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center+ "&zoom=" + zoom;
      
    } 
    else if (this.value == '35') {
    
      window.location.href = "/version_13/nafra2-direct-map/rivers-sea-depth-future?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center+ "&zoom=" + zoom;
...
//get radio value
 ...
 var zoom = map.getView().getZoom(); // Get the current zoom level
  ...
  //Surface water extent
  window.location.href = "/version_13/nafra2-direct-map/surface-water?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center+ "&zoom=" + zoom;

}
else if (this.value == '8') {

  //Surface water depth
  window.location.href = "/version_13/nafra2-direct-map/surface-water-depth?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center+ "&zoom=" + zoom;

} else if (this.value == '9') {

  //Surface water speed
  window.location.href = "/version_13/nafra2-direct-map/rivers-sea?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center+ "&zoom=" + zoom;
} 
else if (this.value == '10') {

  //Surface water speed
  window.location.href = "/version_13/nafra2-direct-map/rivers-sea-depth?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center+ "&zoom=" + zoom;
} 
});
...
if (window.location.pathname.includes("/version_13/nafra2-direct-map/surface-water") || window.location.pathname.includes("/version_13/nafra2-direct-map/surface-water-depth") || window.location.pathname.includes("/version_13/nafra2-direct-map/surface-water-cc") || window.location.pathname.includes("/version_13/nafra2-direct-map/rivers-sea") || window.location.pathname.includes("/version_13/nafra2-direct-map/rivers-sea-cc")) {
...
$(document).ready(function () {
  ...
  function handleDisplayLayersCheckbox() {
    ...
    if (!isChecked) {
      if (currentPath === '/version_13/nafra2-direct-map/surface-water' || currentPath === '/version_13/nafra2-direct-map/surface-water-cc' || currentPath === '/version_13/nafra2-direct-map/surface-water-velocity' || currentPath === '/version_13/nafra2-direct-map/surface-water-depth' || currentPath === '/version_13/nafra2-direct-map/surface-water-depth-future' || currentPath === '/version_13/nafra2-direct-map/rivers-sea-depth' || currentPath === '/version_13/nafra2-direct-map/rivers-sea-depth-future') {
      removeLayers();
    }
    else if (currentPath === '/version_13/nafra2-direct-map/rivers-sea' || currentPath === '/version_13/nafra2-direct-map/reservoirs' || currentPath === '/version_13/nafra2-direct-map/rivers-sea-cc')
      removeLayers();
    }
    // end of if that removes layers

    // if checkbox checked again, return correct layers
    else if (currentPath === '/version_13/nafra2-direct-map/surface-water') {
    removeLayers();
    map.addLayer(surfaceWaterDepth(2));
    /* map.addLayer(surfaceWater(3)),
    map.addLayer(surfaceWater(2)),
    ...
    else if (currentPath === '/version_13/nafra2-direct-map/surface-water-cc') {
      removeLayers();
      map.addLayer(surfaceWaterDepth(3));
      /* map.addLayer(surfaceWater(3)),
      map.addLayer(surfaceWater(2)),
    ...
    else if (currentPath === '/version_13/nafra2-direct-map/rivers-sea') {
      removeLayers();
      map.addLayer(surfaceWaterDepthRos(1));
     /*  map.addLayer(riverSea(4)),
      map.addLayer(riverSea(3)),
      ...
      else if (currentPath === '/version_13/nafra2-direct-map/rivers-sea-cc') {
        removeLayers();
        map.addLayer(surfaceWaterDepthRos(2));
       /*  map.addLayer(riverSea(4)),
        map.addLayer(riverSea(3)),
      ...
      else if (currentPath === '/version_13/nafra2-direct-map/reservoirs') {
        removeLayers();
        map.addLayer(reservoirRiver('DryDay'));
        map.addLayer(reservoirRiver('WetDay'));
        
        }
        else if (currentPath === '/version_13/nafra2-direct-map/surface-water-depth') {
          ...
          //surface water depth medium risk
          ...
          else if (currentPath === '/version_13/nafra2-direct-map/surface-water-depth-future') {
            //surface water depth high risk
             if (scenarioValue == '10') {
              removeLayers();
              map.addLayer(surfaceWaterDepth(1));
          ...
          else if (currentPath === '/version_13/nafra2-direct-map/rivers-sea-depth') {
            ...
            else if (currentPath === '/version_13/nafra2-direct-map/rivers-sea-depth-future') {
              //surface water velocity high risk
               if (scenarioValue == '13') {
                removeLayers();
                map.addLayer(surfaceWaterSpeed(1));
...
$(document).ready(function () {
  ...
  $('#exit-map').on('click', function () {
    window.location.href = '/version_13/nafra2/where-do-you-want-to-check.html.html';
  });

  // rivers map button
  $('#rivers-btn').on('click', function () {
    window.location.href = '/version_13/nafra2-direct-map/rivers-sea.html';
  });
  ...
  $('#res-btn').on('click', function () {
    window.location.href = '/version_13/nafra2-direct-map/reservoirs.html';
  });

  // surface water map button
  $('#sw-btn').on('click', function () {
    window.location.href = '/version_13/nafra2-direct-map/surface-water.html';
  });
