  ...
  return new TileLayer({
    ...
    source: new TileArcGISRest({
      ...
      params: {
        'TRANSPARENT': true,
        'FORMAT': 'GIF',
        'dynamicLayers': `[{"id":${layerIds[likelihood - 1]},"source":{"type":"mapLayer","mapLayerId":${layerIds[likelihood - 1]}},"drawingInfo":{"renderer":{"type":"simple","symbol":{"color":[${layerColorsRed[likelihood - 1]}],"outline":{"width":0,"type":"esriSLS"},"type":"esriSFS","style":"esriSFSSolid"}}}}]`
      }
    }),
    minZoom: 8,
    zIndex: 0,
  ...
  return new TileLayer({
    ...
    source: new TileArcGISRest({
      ...
      params: {
        'TRANSPARENT': true,
        'FORMAT': 'GIF',
        'dynamicLayers' : `[{"id":0,"source":{"type":"mapLayer","mapLayerId":0},"drawingInfo":{"renderer":{"type":"uniqueValue","field1":"depth","uniqueValueInfos":[{"value":"0.00 - 0.15","symbol":{"type":"esriSFS","style":"esriSFSSolid","color":[${lightPink}],"outline":{"type":"esriSLS","width":0}}},{"value":"0.15 - 0.30","symbol":{"type":"esriSFS","style":"esriSFSSolid","color":[${lightPink}],"outline":{"type":"esriSLS","width":0}}},{"value":"0.30 - 0.60","symbol":{"type":"esriSFS","style":"esriSFSSolid","color":[${midOrange}],"outline":{"type":"esriSLS","width":0}}},{"value":"0.60 - 0.90","symbol":{"type":"esriSFS","style":"esriSFSSolid","color":[${midOrange}],"outline":{"type":"esriSLS","width":0}}},{"value":"0.90 - 1.20","symbol":{"type":"esriSFS","style":"esriSFSSolid","color":[${darkRed}],"outline":{"type":"esriSLS","width":0}}},{"value":"> 1.20","symbol":{"type":"esriSFS","style":"esriSFSSolid","color":[${darkRed}],"outline":{"type":"esriSLS","width":0}}}]},"transparency":0}}]`
      }
    }),
    minZoom: 8,
    zIndex: 0
...
removeLayers();
  ...
  if (pathname == '/version_8-2/map-v7-direct/surface-water'){
    map.addLayer(surfaceWater(3))
    map.addLayer(surfaceWater(2))
    map.addLayer(surfaceWater(1))
    /* markerAddressRadius(); */
  } else if (pathname == '/version_8-2/map-v7-direct/surface-water-depth'){
    map.addLayer(surfaceWaterDepth(x))
   /*  markerAddressRadius(); */
  } else if (pathname == '/version_8-2/map-v7-direct/surface-water-velocity'){
    map.addLayer(surfaceWaterSpeed(x)),
    map.addLayer(surfaceWaterDirection(x))
/*     markerAddressRadius(); */
  } else if (pathname == '/version_8-2/map-v7-direct/rivers-sea'){
    map.addLayer(riverSea(4)),
    map.addLayer(riverSea(3)),
    map.addLayer(riverSea(2)),
    map.addLayer(riverSea(1))
  /*   markerAddress(); */
  } else if (pathname == '/version_8-2/map-v7-direct/reservoirs'){
...
if (window.location.pathname.includes("/version_8-2/map-v7-direct/surface-water-depth") || window.location.pathname.includes("/version_8-2/map-v7-direct/surface-water-velocity")) {
...
$(document).ready(function () {
  ...
  function toggleContent(isChecked) {
    ...
    if (currentPath === '/version_8-2/map-v7-direct/surface-water' || currentPath === '/version_8-2/map-v7-direct/surface-water-depth') {
    ...
    } else if (currentPath === '/version_8-2/map-v7-direct/rivers-sea') {
    ...
    } else if (currentPath === '/version_8-2/map-v7-direct/reservoirs') {
...
$(document).ready(function () {
  ...
  function handleDisplayLayersCheckbox() {
    ...
    if (!isChecked) {
      if (currentPath === '/version_8-2/map-v7-direct/surface-water' || currentPath === '/version_8-2/map-v7-direct/surface-water-depth' || currentPath === '/version_8-2/map-v7-direct/surface-water-velocity') {
      removeLayers();
      /* markerAddressRadius(); */
    }
    else if (currentPath === '/version_8-2/map-v7-direct/rivers-sea' || currentPath === '/version_8-2/map-v7-direct/reservoirs')
      removeLayers();
      /* markerAddress(); */
    }
    ...
    else if (currentPath === '/version_8-2/map-v7-direct/surface-water') {
    removeLayers();
    map.addLayer(surfaceWater(3)),
    map.addLayer(surfaceWater(2)),
    map.addLayer(surfaceWater(1))/* ,
    markerAddressRadius() */
      ...
      markerAddress(); */
        ...
        markerAddress(); */
        ...
        else if (currentPath === '/version_8-2/map-v7-direct/surface-water-depth') {
          ...
          else if (currentPath === '/version_8-2/map-v7-direct/surface-water-velocity') {
...
$(document).ready(function () {
  ...
  exitButton.on('click', function () {
    ...
    window.location.href = '/version_8-2/map-v7/where-do-you-want-to-check.html?address=select-an-address-dn19.html&results=results-hx7.html';
  });
});
...
function hideFormGroupsBasedOnPreviousURL() {
  ...
  if (window.location.pathname === '/version_8-2/map-v7-direct/surface-water') {
    ...
    if (previousURL === '/version_8-2/map-v7-direct/surface-water-velocity') {
