...
if (window.location.pathname.includes("/version_8-2/map-v7/surface-water-depth") || window.location.pathname.includes("/version_8-2/map-v7/surface-water-velocity")) {
...
$(document).ready(function () {
  ...
  function handleDisplayLayersCheckbox() {
    ...
    if (!isChecked) {
      if (currentPath === '/version_8-2/map-v7/surface-water' || currentPath === '/version_8-2/map-v7/surface-water-depth' || currentPath === '/version_8-2/map-v7/surface-water-velocity') {
      removeLayers();
      markerAddressRadius();
    }
    else if (currentPath === '/version_8-2/map-v7/rivers-sea' || currentPath === '/version_8-2/map-v7/reservoirs')
      removeLayers();
      markerAddress();
    }
    ...
    else if (currentPath === '/version_8-2/map-v7/surface-water') {
    removeLayers();
    map.addLayer(surfaceWater(3)),
    map.addLayer(surfaceWater(2)),
    map.addLayer(surfaceWater(1)),
    markerAddressRadius()
      ...
      markerAddress();
        ...
        markerAddress();
        ...
        else if (currentPath === '/version_8-2/map-v7/surface-water-depth') {
          ...
          else if (currentPath === '/version_8-2/map-v7/surface-water-velocity') {
...
function hideFormGroupsBasedOnPreviousURL() {
  ...
  if (window.location.pathname === '/version_8-2/map-v7/surface-water') {
    ...
    if (previousURL === '/version_8-2/map-v7/surface-water-velocity') {
