...
removeLayers();
  ...
  if (pathname == '/map/surface-water'){
    ...
    markerAddressRadius();
  } else if (pathname == '/map/surface-water-depth'){
    map.addLayer(surfaceWaterDepth(x)),
    markerAddressRadius();
  } else if (pathname == '/map/surface-water-velocity'){
    map.addLayer(surfaceWaterSpeed(x)),
    markerAddressRadius();
  } else if (pathname == '/map/rivers-sea'){
    map.addLayer(riverSea(x)),
    markerAddress();
  } else if (pathname == '/map/reservoirs'){
...
//get Center of map
  let center = map.getView().getCenter()
      ...
      if (this.value == '1') {
        ...
        //surface water
      window.location.href = "/map/surface-water?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center
    }
    else if (this.value == '2') {

      // rivers and sea
      window.location.href = "/map/rivers-sea?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center
    } else if (this.value == '3') {
    
      //reservoirs
      window.location.href = "/map/reservoirs?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center
...
//get radio value
 ...
 let center = map.getView().getCenter()
  ...
  //Surface water depth
  window.location.href = "/map/surface-water-depth?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center

} else if (this.value == '9') {

  //Surface water speed
  window.location.href = "/map/surface-water-velocity?marker="+setCheckbox+"&scenario="+setRadio+"&center="+center
} 
});
